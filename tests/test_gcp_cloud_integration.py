...
def test_gcp_model_upload_and_access_via_api(test_model, training_params, conda_env):
    with DockerCompose(
        filepath=".", compose_file_name=["docker-compose.gcp-test.yaml"], pull=True, build=True
    ) as compose:
        ...
        experiment_name = "gcp-cloud-experiment"
        model_name = "test-gcp-model"
        stage_name = "Staging"
